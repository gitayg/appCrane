...
// Inline Lucide icons. Source: lucide.dev (MIT). Same set as the React SPA.
// Strings rather than imports because shared.js is plain ES5.
const ICONS = {
...
function sidebar(active, subItems, activeSub) {
  const pages = [
    ...
    {id:'applications',label:'Applications',href:'/applications', icon:ICONS.applications},
    {id:'users',      label:'Users',        href:'/users-page',   icon:ICONS.users},
    {id:'audit',      label:'Audit Log',    href:'/audit-page',   icon:ICONS.audit},
    {id:'mcp',        label:'MCP',          href:'/settings#mcp', icon:ICONS.mcp},
